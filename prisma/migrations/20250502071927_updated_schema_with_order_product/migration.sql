...
-- AddForeignKey
ALTER TABLE `Product` ADD CONSTRAINT `Product_brandManagerId_fkey` FOREIGN KEY (`brandManagerId`) REFERENCES `BrandManager`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
